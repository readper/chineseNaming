...
func main() {
	...
	e.GET("/names", func(c echo.Context) error {
		...
		nameWords := make([][]models.Word, 0)
		for _, word := range orderWords[minOrder] {
			nameWords = append(nameWords, []models.Word{word})
		}
